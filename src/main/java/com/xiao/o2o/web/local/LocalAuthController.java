...
import com.xiao.o2o.enums.LocalAuthStateEnum;
import com.xiao.o2o.exception.LocalAuthOperationException;
import com.xiao.o2o.service.LocalAuthService;
import com.xiao.o2o.util.CodeUtil;
import com.xiao.o2o.util.HttpServletRequestUtil;
import com.xiao.o2o.util.MD5;
...
public class LocalAuthController {
	...
	@ResponseBody
	private Map<String, Object> localLoginCheck(HttpServletRequest request) {
	...
	private Map<String, Object> changeLocalPwd(HttpServletRequest request) {
		...
		//从session中获取当前用户的信息(用户一旦通过微信登录后，便能获取到用户的信息)
		PersonInfo user = (PersonInfo) request.getSession().getAttribute("user");
