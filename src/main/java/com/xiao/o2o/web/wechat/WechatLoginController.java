package com.xiao.o2o.web.wechat;
...
import com.xiao.o2o.dto.UserAccessToken;
import com.xiao.o2o.dto.WechatAuthExecution;
import com.xiao.o2o.dto.WechatUser;
...
import com.xiao.o2o.util.wechat.WechatUtil;

@Controller
@RequestMapping("wechatlogin")
/**
 * 获取关注公众号之后的微信用户信息的接口，如果在微信浏览器里访问
 * https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxa467bd389ae045d9&redirect_uri=http://106.14.180.160/o2o/wechatlogin/logincheck&role_type=1&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect
