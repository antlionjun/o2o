package com.xiao.o2o.util.wechat;
...
public class WechatUtil {
    ...
    public static UserAccessToken getUserAccessToken(String code) throws IOException {
        // 测试号信息里的appId
        String appId = "wxa467bd389ae045d9";
        log.debug("appId:" + appId);
        // 测试号信息里的appsecret
        String appsecret = "dfc060f6e069fe242ed4c294ff16613d";
    ...
    /**
     * 将WechatUser里的信息转换成PersonInfo信息并返回personInfo
     * @param user
     * @return
     */
